...
import com.official.core.base.search.exception.InvalidSearchOperatorException;
...
public final class Condition implements SearchFilter{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1718053090409739563L;
	...
	public String getOperator() throws InvalidSearchOperatorException {
		return operator;
	}
