...
public class BaseRepositoryFactoryBean<R extends JpaRepository<T, I>, T extends Entity<I>, I extends Serializable>
	...
	private static class MyRepositoryFactory<T extends Entity<I>, I extends Serializable> extends JpaRepositoryFactory {
